...
namespace ADYC.Service.Tests.FakeRepositories
{
    ...
    {
        //public static List<Term> terms = TestData.Terms;
        ...
        public static Offering computerLabJonhDFall2017 = TestData.computerLabJonhDFall2017;
        ...
        //    new Professor { Id = Guid.Parse(ProfessorGuids[3]), FirstName = "Peter", LastName = "Parker", IsDeleted = false },
