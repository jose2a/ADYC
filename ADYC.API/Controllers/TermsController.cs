...
namespace ADYC.API.Controllers
{
    ...
    public class TermsController : ApiController
    {
        ...
        //[Route("{termId}/PeriodDates/{periodId}")]
        //[ResponseType(typeof(PeriodDateDto))]
        //public IHttpActionResult GetPeriodDate(int termId, int periodId)
        //{
        //    var periodDate = _periodDateService.Get(periodId, termId);

        //    if (periodDate != null)
        //    {
        //        var periodDateDto = new PeriodDateDto
        //        {
        //            Url = UrlResoucesUtil.GetBaseUrl(Request, "Terms") + termId + "/PeriodDate/" + periodId,
        //            TermId = periodDate.TermId,
        //            PeriodId = periodDate.PeriodId,
        //            StartDate = periodDate.StartDate,
        //            EndDate = periodDate.EndDate,
        //            Term = periodDate.Term.Name,
        //            Period = Mapper.Map<Period, PeriodDto>(periodDate.Period),
        //        };

        //        periodDateDto.Period.Url = UrlResoucesUtil.GetBaseUrl(Request, "Periods") + periodId;

        //        return Ok(periodDateDto); 
        //    }
        ...
        public IHttpActionResult GetPeriodDatesForTerm(int termId)
        {
            ...
            {
                Url = UrlResoucesUtil.GetBaseUrl(Request, "Terms") + termId + "/PeriodDate",
