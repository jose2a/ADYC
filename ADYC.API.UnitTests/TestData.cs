...
namespace ADYC.API.UnitTests
{
    public class TestDataApi
    {
        ...
        public static Offering computerLabJohnDSpring2018 = new Offering
        {
            ...
            Schedules = new List<Schedule>
            {
                new Schedule { Id = 15, Day = Day.Tuesday, OfferingId = 8, Offering = TestDataApi.computerLabJohnDSpring2018, StartTime = new TimeSpan(8, 15, 0), EndTime = new TimeSpan(10, 0, 0) },
                new Schedule { Id = 16, Day = Day.Thrusday, OfferingId = 8, Offering = TestDataApi.computerLabJohnDSpring2018, StartTime = new TimeSpan(8, 15, 0), EndTime = new TimeSpan(10, 0, 0) }
            }
        };
